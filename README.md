...
This was a project in which we had to train a quadruped robot to walk through tricky terrain. This was done using machine learning, in combination with various control techniques (Central Pattern Generators, Cartesian Control and Cartisian Proportional Derivative). 
